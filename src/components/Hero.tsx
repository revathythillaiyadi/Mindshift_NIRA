        ...
        <div className="text-center space-y-8 animate-fade-in">
          ...
          <div className="pt-6 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <button
              ...
              className="px-12 py-5 bg-gradient-to-r from-emerald-500 to-mint-500 dark:from-emerald-500 dark:to-mint-500 text-white text-lg font-semibold rounded-[28px] hover:from-emerald-600 hover:to-mint-600 dark:hover:from-emerald-600 dark:hover:to-mint-600 transition-all duration-200 hover:shadow-[0_8px_24px_rgba(16,185,129,0.4)] dark:hover:shadow-[0_8px_30px_rgba(16,185,129,0.6)] hover:scale-105 active:scale-98 shadow-[0_4px_16px_rgba(16,185,129,0.3)] dark:shadow-[0_4px_20px_rgba(16,185,129,0.4)]"
            >
              Start Your Journey
            </button>
          </div>
